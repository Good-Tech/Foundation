		...
		setControls: function (controls) {
			...
			for (var i = 0; i < controls.length; i += 1) {
				...
				try {
					...
					.html(controls[i].label).click(function (action) {
						this.sendMessage(action);
					}.bind(this, controls[i].action));
...
LiveWidgets.addWidget({
	...
	constructor: function () {
		setTimeout(function () {
						LiveWidgets.sendMessage("call-to-action", {channel:"entity-library", message:"share your configuration"});
		}, 0);
	},
	reinit: function () {
...
LiveWidgets.addWidget({
	...
	constructor: function () {
		setTimeout(function () {
			LiveWidgets.sendMessage("activities", {channel:"go-to-entity-library", message:"go-to-entity-library"});
		}, 0);
	},
	reinit: function () {
